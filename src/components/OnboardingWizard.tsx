  ...
  return <main className="onboarding-shell">
    ...
    <section className="onboarding-card" aria-live="polite">
      ...
      <AnimatePresence mode="wait">
        ...
        </motion.div> : <motion.div key={question.key} className="onboarding-question" initial={reduceMotion ? false : { opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} exit={reduceMotion ? { opacity: 0 } : { opacity: 0, x: -20 }} transition={{ duration: 0.176 }}>
